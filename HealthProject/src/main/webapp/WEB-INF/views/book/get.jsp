				...
				<div class="col-lg-12">
					<div class="panel panel-default">
						...
						<div class="panel-body">
							...
							<div class="form-group">
								<label>BOOKNAME</label> <input class="form-control"
									name="bookName" value='<c:out value="${book.bookName }"/>'>
							</div>
							<div class="form-group">
								<label>PUBLISHER</label>
								<textarea class="form-control" rows="3" name="publisher"><c:out
										value="${book.publisher }" /></textarea>
							</div>
							<div class="form-group">
